                        ...
                        <div class="flex flex-col w-full max-w-sm mx-auto p-4 bg-white">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="description" class="text-sm sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400 focus:outline-none py-2 pr-2 pl-12">{{$portofolio->description}}</textarea>
